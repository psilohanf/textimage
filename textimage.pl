...
system("convert -size 420x360 -background '#$bg[$theme]' -fill '#$f1[$theme]' -bordercolor '#$bg[$theme]' -gravity SouthWest -font Times-Roman caption:'\"$quote\"' -border 30 -crop 420x390+30+0 -font Times-Roman -gravity SouthEast -size 420x30 -fill '#$f2[$theme]' caption:'($author)' -append -border 30 +repage quote.gif");
